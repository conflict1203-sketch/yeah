...
for conf in "$SCRIPTS_DIR"/*.conf; do
    sed -i "" \
        -e 's|\.\./\.\./ddgksf2013/js/|https://gitlab.com/conflict1203/QuantumultX/-/raw/master/external/ddgksf2013/js/|g' \
        -e 's|\.\./\.\./ddgksf2013/rartv/|https://gitlab.com/conflict1203/QuantumultX/-/raw/master/external/ddgksf2013/rartv/|g' \
        "$conf"
